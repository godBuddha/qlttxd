...
- ✅ Excludes: backend/, db/, scripts/, docs/, *.md, .git/, .env, docker-compose.yml, core.*
- ✅ Keeps: frontend/, Caddyfile

**app/backend/.dockerignore**:
- ✅ Excludes: node_modules, test/, test-*.mjs, test-*.js, TEST-RESULT*, *.md, .env
- ✅ Keeps: server.js, package*.json, Dockerfile

**app/frontend/.dockerignore**:
- ✅ Excludes: node_modules, dist, e2e/, core.*, test-*.mjs, TEST-RESULT*, *.md
